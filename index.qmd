...
description-meta: "A Data Scientist interested in applying my knowledge of causal inference, statistics, probabilistic thinking, and machine learning to problems of understanding human behaviour."
...
writeLines(redirects_combined, here::here("_redirects"))
```