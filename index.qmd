...
description-meta: |
  I am a data scientist interested in applying my knowledge of causal inference, 
  statistics, probabilistic thinking, and machine learning to problems of understanding 
  human behaviour.
twitter-card:
    title: Paul Johnson
    description: |
