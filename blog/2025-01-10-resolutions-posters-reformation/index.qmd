...
description-meta: |
    Reflecting on this blog's development in 2024, before considering what I want
    to achieve in 2025 and how I want to continue improving as a data scientist.
date: 2025-01-10
...
I haven't studied the Reformation, but I assume it was just a bunch of lovely lads who travelled around Europe being **very** normal about Christianity.

[^Substack]:

Are Substacks blogs? From a content perspective, what's really the difference between a newsletter and a blog? I think they're the same. Is this a heathen's take?
...
I suspect that writing quick, interesting analyses is as much about the setup as it is about the writing. Identifying questions interesting enough to bother answering but simple enough to tackle quickly is not easy!

[^Football]:

I've heard posts don't **have** to be about football, either, though I've yet to see any evidence to support this claim.
...
_An Introduction to Statistical Learning_ is one of those books I've read a decent chunk of over the years but never start to finish.
