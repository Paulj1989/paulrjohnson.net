...
description-meta: |
  A blog post exploring the use of desirability functions, a multivariate optimisation 
  method, for creating rating systems, using offensive player data for the 2023/24 season.
date: 2024-02-22
image: math.webp
image-alt: A blackboard with a many diagrams and mathematical operations drawn on it.
categories: [Optimisation, Football Analytics, Data Science, R]
