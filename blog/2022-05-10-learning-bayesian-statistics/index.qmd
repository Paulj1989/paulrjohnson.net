...
subtitle: |
  Learning Bayesian statistics is a real sicko move. Here are some resources 
  that will provoke your worst instincts. **Yes... Ha Ha Ha... <u>Yes</u>!**
description-meta: |
  Compiling a list of the best resources for learning Bayesian statistics, from 
  introductory texts such as Statistical Rethinking to the more advanced like 
  Bayesian Data Analysis.
date: 2022-05-10
image: bayes.webp
image-alt: A hand-drawn portrait of Thomas Bayes.
categories: [Bayesian Statistics, Statistics]
---
