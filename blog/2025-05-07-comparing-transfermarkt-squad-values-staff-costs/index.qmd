---
title: How Reliable are Transfermarkt's Squad Values?
subtitle: |
  Using the DFL's financial reports to compare Transfermarkt's squad values with
  Bundesliga staff costs.
description-meta: |
...
### Differences Between Squad Values & Staff Costs
...
#| tbl-cap: Average Difference Between Squad Values & Staff Costs in the Bundesliga
#| code-fold: true
...
### Similarities (Correlation) Between Squad Values & Staff Costs
...
buli_resources |>
  ...
  labs(
    title = "Relationship Between Staff Costs & Squad Values in the Bundesliga",
    subtitle = stringr::str_wrap(
      glue::glue(
...
buli_resources |>
  ...
  labs(
    title = "League Outcomes by Squad Value & Staff Cost in the Bundesliga",
    subtitle = stringr::str_wrap(
      glue::glue(
        "Comparing the association between squad values and staff costs and league ",
        "outcomes - points, goal difference, and xG difference - in the Bundesliga ",
        "across the 2017/18 - 2022/23 seasons."
      ),
      width = 93
    ),
    x = NULL,
...
#| tbl-cap: Comparing the Predictive Performance of Squad Values & Staff Costs
#| code-fold: true
#| code-summary: 'Table Code (Click to Expand)'
