...
One of Lua's strengths is its pattern matching system (similar to regular expressions but simpler). The script uses this to find blog posts.
...
Every time I publish a new blog post or add categories, the redirects are automatically updated without any manual intervention.
