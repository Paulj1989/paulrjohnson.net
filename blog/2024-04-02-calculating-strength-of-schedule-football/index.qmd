...
As discussed in @sec-sos-methodology, z-scores are interpreted as the standard deviation from the mean. A z-score of -1.12 means that Liverpool's schedule is 1.09 standard deviations lower than the mean league schedule.
