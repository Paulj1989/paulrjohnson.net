...
subtitle: |
  An extension of the Quarto documentation (that didn't work off the shelf for
  me) for getting a Hugo website working with Quarto seamlessly.
image: hugo.webp
...
**Note: Having ported my site over to Quarto in entirety, this blog post no longer applies to the site as is. This post should hopefully still work for anyone that is using Quarto with Hugo!**
