...
subtitle: |
  How to combine the functionality from both the **tidymodels** framework and 
  **caret** to build models that combine the best of both worlds.
date: 2022-05-07
image: robot.webp
image-alt: A light blue toy robot.
categories: [Machine Learning, Caret, Tidymodels, Data Science, R]
---
