---
title: Automating Netlify Redirects in Quarto Using Lua
subtitle: |
    Save yourself from yourself by generating website redirects using a Lua script.
description-meta: |
    A look at the  Lua programming language and how it can be used to
    automatically generate Netlify redirects for blog posts and categories in a
    Quarto website.
date: 2025-06-04
image: traffic.webp
image-alt: |
...
If you need to learn Lua, I recommend the [Learn Lua in 15 Minutes](https://learnxinyminutes.com/lua/) resource, as well as Quarto's [Lua Cheatsheet](https://quarto.org/docs/extensions/luarefv51.pdf).
